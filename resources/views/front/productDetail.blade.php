        ...
        <div class="w-full grid lg:grid-cols-3  grid-cols-1 gap-2 ">
            ...
            <div class="w-full flex flex-col  shrink-0  xl:pl-2 xl:pr-2">
                ...
                <div class="pt-1.5 lg:pt-3 xl:pt-4 space-y-2.5 md:space-y-3.5">
                    <form action="{{Auth::guard('admin')->user()?route('cart.store'):route('login')}}" method="{{Auth::guard('admin')->user()?'post':'get'}}">
                        @csrf
                    ...
                    <div class="grid grid-cols-2 gap-2.5">
                        <a data-variant="border" href="{{Auth::guard('admin')->user()?route('wishlist.add', ['product' => $showProduct->id]) : route('login')}}"
                ...
                <ul class="pt-5 xl:pt-6">
                    ...
                    @if($showProduct->productTags->count() > 0)
                         @foreach($showProduct->productTags as $tag)
        ...
        <div class="w-full xl:px-2 py-11 lg:py-14 xl:py-16 sm:px-0">
            ...
            <div class="mt-6 lg:mt-9">
                ...
                <div class="flex " id="tab1">
                    <div class="text-sm sm:text-[15px] text-gray-500 leading-[2em] px-4 space-y-4 lg:space-y-5 xl:space-y-7">
                ...
                {{--second tab--}}
                <div class="grid lg:grid-cols-3 md:grid-cols-3 s:grid-cols-2 grid-cols-1" id="tab2">
                    <div class="w-full lg:col-span-2 md:col-span-2 col-span-1 pt-2 px-4">

                        @if($showProduct->reviews->count()==0)
                            <div class="border-b border-border-base last:border-0 pb-6 mb-6 last:mb-0 ">
                                <h3 class="text-brand-dark text-[15px] sm:text-base font-semibold mb-1.5">No Review Yet</h3>
                            </div>
                            @else
                            ...
                            <h3 class="text-brand-dark text-[15px] sm:text-base font-semibold mb-1.5">{{$review->title}}</h3>
                            <p class="text-gray-500 text-sm leading-7 lg:leading-[27px] lg:text-[15px] xl:leading-[2em]">{{$review->message}}</p>
                            <div class="pt-2 text-md text-gray-800 text-opacity-80">By<span
                                    class="inline-block ml-[3px] mr-[3px] font-semibold">{{$review->user->name}}</span>
                            </div>
                        </div>
                             @endforeach
                    ...
                    <div class="w-full lg:pl-10 lg:pr-10 xl:pl-14 xl:pr-14 3xl:pl-20 3xl:pr-20 shrink-0 pt-10">
                        ...
                        <form action="{{route('product.review', ['product'=>$showProduct->id])}}" method="POST" class="flex flex-col justify-center w-full mx-auto mt-5 lg:mt-7 xl:mt-9">
                            @csrf
                            <div class="flex flex-col space-y-5 md:space-y-6 lg:space-y-7">
                                <div class="pb-1.5 flex gap-2 items-center">
                                    <label class="block text-sm leading-none cursor-pointer shrink-0 text-gray-900 md:text-[15px] ltr:pr-3 rtl:pl-3">Your Rating *</label>
                                    <div class="">
                                        <ul class="rc-rate flex flex-col [&amp;>li]:cursor-pointer [&amp;.rc-rate-disabled>li]:cursor-default [&amp;>li]:relative [&amp;>li]:mr-0.5 rtl:[&amp;>li]:ml-0.5 [&amp;>li]:inline-block text-gray-200 [&amp;>li>div>.rc-rate-star-first]:absolute [&amp;>li>div>.rc-rate-star-first]:left-0 rtl:[&amp;>li>div>.rc-rate-star-first]:right-0 [&amp;>li>div>.rc-rate-star-first]:top-0 [&amp;>li>div>.rc-rate-star-first]:w-1/2 [&amp;>li>div>.rc-rate-star-first]:h-full [&amp;>li>div>.rc-rate-star-first]:overflow-hidden [&amp;>.rc-rate-star-half>div>.rc-rate-star-first]:text-yellow-400 [&amp;>.rc-rate-star-full>div]:text-yellow-400 [&amp;>li>div]:transition-all [&amp;>li>div]:duration-300 [&amp;>.rc-rate-star:hover]:scale-110"
                                            tabindex="0" role="radiogroup">
                                            <li class="text-yellow-500 flex items-center w-40">
                                                  <div class=" relative flex justify-between">
                                                      <div>
                                                          <i class="fa fa-star"></i>
                                                      </div>
                                                      <div class="flex items-center me-4">
                                                          <input id="green-radio" type="radio" value="1" name="rating" class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500">
                                                      </div>
                                                  </div>
                                              </li>
                                            <li class="text-yellow-500 flex items-center w-40">
                                                <div class="  relative flex justify-between">
                                                   <div>
                                                    ...
                                                    <div class="flex items-center me-4">
                                                        <input id="green-radio" type="radio" value="2" name="rating" class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500">
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="text-yellow-500 flex items-center w-40">
                                                <div class="  relative flex justify-between">
                                                 <div>
                                                    ...
                                                    <div class="flex items-center me-4">
                                                        <input id="green-radio" type="radio" value="3" name="rating" class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500">
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="text-yellow-500 flex items-center w-40">
                                                <div class="  relative flex justify-between">
                                                    ...
                                                    <div class="flex items-center me-4">
                                                        <input id="green-radio" type="radio" value="4" name="rating" class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500">
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="text-yellow-500 flex items-center w-40">
                                                <div class="  relative flex justify-between">
                                                    ...
                                                    <div class="flex items-center me-4">
                                                        <input id="green-radio" type="radio" value="5" name="rating" class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500">
                                                    </div>
                                                </div>
                                            </li>
                                ...
                                <div class="block">
                                    <label for="name"
                                           class="block font-normal text-sm leading-none mb-3 cursor-pointer text-brand-dark text-opacity-70">Title *</label>
