                    ...
                    <div class="flex mx-auto rounded-lg bg-white">
                        ...
                        <div class="w-full md:w-1/2 lg:w-[45%] xl:w-[40%] py-6 sm:py-10 px-4 sm:px-8 md:px-6 lg:px-8 xl:px-12 rounded-md flex flex-col justify-center">
                            <div class="mb-6 text-center">
                                ...
                                <h4 class="text-xl font-semibold text-gray-900 sm:text-2xl sm:pt-3 ">Change Password</h4>
                                <div class="mt-3 mb-1 text-sm text-center sm:text-15px text-body">Change your password
                                    <a href="{{route('signup')}}">
                                        <button type="button"
                            ...
                            <form class="flex flex-col justify-center" action="{{route('changePassword')}}" method="post">
                                @csrf
                                <div class="flex flex-col space-y-3.5">
                                    <div class="block text-left">
                                        ...
                                        <input id="email" name="email" type="email" placeholder="Enter your email address"
                                               ...
                                               aria-invalid="false" value="{{$userEmail}}" disabled>
                                    </div>
                                    @error('email')
                                    <span>{{$message}}</span>
                                    @enderror
                                    ...
                                    @endif
                                    <div class="block text-left">
                                        <label for="new_password" class="block mb-3 text-sm font-normal leading-none cursor-pointer text-gray-900 opacity-70">
                                           New Password
                                        </label>
                                        <div class="relative">
                                            <input id="password" name="new_password" type="password"
                                                   ...
                                                   autocomplete="off" spellcheck="false">
                                            <label for="new_password" class="absolute -mt-2 cursor-pointer right-4 top-5 text-brand-dark text-opacity-30">
                                    ...
                                    <div class="block text-left">
                                        <label for="confirm_new_password" class="block mb-3 text-sm font-normal leading-none cursor-pointer text-gray-900 opacity-70">
                                            Confirt New Password
                                        </label>
                                        <div class="relative">
                                            <input id="newPassword" name="confirm_new_password" type="password"
                                                   class="py-2 px-4 md:px-5 w-full appearance-none transition duration-150 ease-in-out border text-input text-13px lg:text-sm font-body rounded-md placeholder-[#B3B3B3] transition duration-200 ease-in-out text-brand-dark border-border-two focus:border-2 focus:outline-none focus:ring-0 focus:border-brand h-11 md:h-12"
                                                   autocomplete="off" spellcheck="false">
                                            <label for="confirm_new_password" class="absolute -mt-2 cursor-pointer right-4 top-5 text-brand-dark text-opacity-30">
                                                <div class="h-max w-max"  onclick="
