...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('/assets/images/logo/fav.png')}}">
                        ...
                        <form action="{{route('searchProduct')}}" method="POST" class="relative flex flex-col w-full rounded-md" novalidate="" role="search">
                            ...
                            <label for="top-bar-search" class="flex flex-1 items-center py-0.5">
                                <input id="top-bar-search"
                                       ...
                                       autocomplete="off"
                                       name="searchBox"
                                       value="" list="programmingLanguages">
                                <datalist id="programmingLanguages">
                                 @php
                                    $products = \App\Models\Product::where('is_featured', 'yes')->get();
                                 @endphp
...
<footer class="mt-[50px] lg:mt-14 2xl:mt-16">
    <div class="mx-auto max-w-[1920px] px-4 md:px-6 lg:px-8 2xl:px-10">
        <div class="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 pb-[50px]">
            <div class="pb-10 sm:pb-0 mb-4 border-b col-span-full sm:col-span-1 md:col-span-3 sm:border-b-0 border-b-gray-300 sm:mb-0">
                <div
            ...
            <div class="pb-3.5 sm:pb-0 col-span-1 md:col-span-2">
                ...
                <ul class="flex flex-col space-y-3 text-sm lg:text-[15px]">
                    <li class="flex items-baseline"><a class="transition-colors duration-200 hover:text-gray-300"
                                                       href="{{route('termsConditions',['type'=>'term_and_conditions'])}}">Terms & Conditions</a></li>
                    <li class="flex items-baseline"><a class="transition-colors duration-200 hover:text-gray-300"
                                                       href="{{route('termsConditions',['type'=>'privacy_policy'])}}">Privacy Policies</a></li>
                    <li class="flex items-baseline"><a class="transition-colors duration-200 hover:text-gray-300"
                                                       href="{{route('termsConditions',['type'=>'shipping_policy'])}}">Shipping Policies</a></li>
                    <li class="flex items-baseline"><a class="transition-colors duration-200 hover:text-gray-300"
                                                       href="{{route('termsConditions',['type'=>'refund_policy'])}}">Refund Policies</a></li>
            ...
            <div class="pb-3.5 sm:pb-0 col-span-1 md:col-span-2">
                ...
                <ul class="flex flex-col space-y-3 text-sm lg:text-[15px]">
                    <li class="flex items-baseline"><a class="transition-colors duration-200 hover:text-gray-300"
                                                       href="/">01781 200-705</a></li>
                    <li class="flex items-baseline"><a class="transition-colors duration-200 hover:text-gray-300"
                                                       href="/">info@himrooz.com</a></li>
                    <li class="flex items-baseline"><a class="transition-colors duration-200 hover:text-gray-300"
                                                       href="/">www.himrooz.com</a></li>
                </ul>
            </div>
            <div class="flex flex-col pt-8 border-t col-span-full sm:col-span-1 md:col-start-4 xl:col-start-auto md:col-span-4 xl:col-span-3 xl:pl-6 xl:pr-6 sm:pt-0 sm:border-t-0 border-border-three 2xl:pl-7 2xl:pr-7 3xl:pl-16 3xl:pr-16">
