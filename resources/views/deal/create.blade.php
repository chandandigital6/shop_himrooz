                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" disabled class="form-control" placeholder="{{$product->title}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="datetime-local" name="start_time" id="start_time" placeholder="Deal Start From"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="datetime-local" name="end_time" id="end_time" placeholder="Expire on"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
